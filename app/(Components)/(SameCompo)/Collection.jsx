    ...
    <div className="p-5 grid grid-flow-row gap-6">
      ...
      <div className="grid grid-flow-col grid-cols-6 gap-3  mex:grid-flow-row mex:grid-cols-2">
        <div className="relative flex items-end justify-start border-[1px] p-2 smex:col-span-2">
          ...
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Gifts Under 200
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2 smex:col-span-2">
      ...
      <div className="grid grid-flow-col gap-3 mex:grid-flow-row mex:grid-cols-2">
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i4} alt="999 Silver Frames" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            999 Silver Frames
          </h3>
        </div>
        ...
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i6} alt="Home Decor" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Home Decor
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i7} alt="German Silver Gifts" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            German Silver Gifts
          </h3>
        </div>
      ...
      <div className="grid grid-flow-col gap-3 mex:grid-flow-row mex:grid-cols-2">
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i8} alt="Rerturn Gifts" className="h-[200px]" />
          <h3 className="absolute font-bold xl:text-[20px] p-4">
            Return Gifts
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i9} alt="Brass Gifts" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Brass Gifts
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i1} alt="Wedding Trays" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Wedding Trays
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i2} alt="Gift Sets" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Gift Sets
          </h3>
        </div>
      ...
      <div className="grid grid-flow-col gap-3 mex:grid-flow-row mex:grid-cols-2">
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i10} alt="Combos" className="h-[200px]" />
          <h3 className="absolute font-bold xl:text-[20px] p-4">Combos</h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i11} alt="New Arrivals Today" className="h-[200px]" />
          <h3 className="absolute font-bold  xl:text-[20px] p-4">
            New Arrivals Today
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i12} alt="Diwali Collection" className="h-[200px]" />
          <h3 className="absolute font-bold xl:text-[20px] p-4">
            Diwali Collection
          </h3>
        </div>
        <div className="relative flex items-end justify-start border-[1px] p-2">
          <Image src={i13} alt="Garlands" className="h-[200px]" />
          <h3 className="absolute font-bold text-white xl:text-[20px] p-4">
            Garlands
          </h3>
        </div>
